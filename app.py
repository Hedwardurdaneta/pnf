...
def main(page: ft.Page):
    ...
    # CORRECCIÓN DE ALINEACIÓN (Capturas 6 y 8)
    ...
    def layout_contenedor(elementos):
        return ft.Container(
            ...
            # CORRECCIÓN IMAGEFIT (Captura 3): Usamos string directo para evitar el error de atributo
            image_fit="cover", 
    ...
    def ejecutar_examen():
        ...
        if state["idx"] < len(preguntas[u]):
            ...
            page.add(layout_contenedor([
                ...
                ft.Text("Sincronizado" if exito else "Error de red", color="#d1d1d1"),
