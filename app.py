...
# Verificado en su captura de GitHub
...
def guardar_en_nube(nombre_alumno, unidad, puntos):
    ...
    try:
        ...
        # Nombre del archivo verificado en su captura de Google Sheets
        ...
        if nombre_alumno in lista_nombres:
            ...
            # Mapeo: UNIDAD I -> Col D(4), II -> E(5), III -> F(6)
...
def main(page: ft.Page):
    ...
    def layout_contenedor(elementos):
        return ft.Container(
            ...
            # CORRECCIÓN DE IMAGEFIT: Usamos string para compatibilidad total
            image_fit="cover", 
